...
import useUnstakeTimerMasonry from '../../../hooks/staking/useUnstakeTimerMasonry';
...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(platFinance.SPLAT, platFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(platFinance.SPLAT);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('SPLAT', platFinance.SPLAT);
