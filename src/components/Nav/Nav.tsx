        ...
        {matches ? (
          <>
            <Typography variant="h6" color="inherit" noWrap className={classes.toolbarTitle}>
              {/* <a className={ classes.brandLink } href="/">Platinum Finance</a> */}
            ...
            <Box mr={5}>
              ...
              <a href="https://docs.platinumfi.xyz/" className={classes.link}>
                Docs
              </a>
            </Box>
          ...
          <>
            ...
            >
              ...
              <List>
                ...
                <ListItemLink primary="Bonds" to="/pit" />
                <ListItemLink primary="Regulations" to="/regulations" />
                <ListItem button component="a" href="https://docs.platinumfi.xyz/main/about-us">
